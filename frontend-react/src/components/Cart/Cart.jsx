...
class Cart extends Component {
  ...
  removeItem = (id) => {
    axios
      ...
      .then((response) => {
        if (response.data === 1) {
          cogoToast.success("Xóa thành công", {
            position: "top-right",
          });
          this.setState({
  ...
  ItemPlus = (id, quantity, price) => {
    axios
      ...
      .then((response) => {
        if (response.data === 1) {
          cogoToast.success("Thêm số lượng thành công", {
            position: "top-right",
          });
          this.setState({
            PageRefreshStatus: true,
  ...
  confirmOnClick = () => {
    ...
    if (city.length === 0) {
      ...
      axios
        ...
        .then((response) => {
          if (response.data === 1) {
            cogoToast.success("Đã nhận được order từ khách hàng", {
              position: "top-right",
            });
            this.setState({
