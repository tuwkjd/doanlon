...
class ProductDetails extends Component {
  ...
  PriceOption(price, special_price) {
    if (special_price === "na") {
      return <span className={`${classes["original-price"]}`}>{price}VND</span>;
    } else {
      return (
        <Fragment>
          ...
          <br />
          <span className={`${classes["original-price"]}`}>vnd{price}</span>
          <span className={`${classes["discount-percent"]}`}></span>
        </Fragment>
      );
    }
  }
